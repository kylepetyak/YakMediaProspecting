          ...
          <CardContent className="space-y-4">
            <div className="bg-white rounded-lg p-4 border-l-4 border-amber-600">
              ...
              <ol className="text-sm space-y-2 ml-4 list-decimal">
                <li>Click "Quick Start Guide" below</li>
                <li>Copy the SQL script from the guide</li>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-900">
                💡 <strong>Tip:</strong> The Quick Start guide has step-by-step instructions and the SQL script you need to run.
              </p>
            </div>
            
            <div className="flex flex-col gap-2">
              <Link to="/quick-start" className="w-full">
      ...
      <div className="max-w-7xl mx-auto p-4 md:p-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="mb-2">Yak Media Prospecting Tool</h1>
              <p className="text-muted-foreground">
                10-Point Marketing Analysis • Comprehensive Lead Generation System
              </p>
              {user?.email && (
          ...
          <Card className="border-slate-200">
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-muted-foreground">System Focus</p>
                  <div className="text-xl">Ongoing Prospecting</div>
                </div>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-xl">All Sectors</div>
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card className="border-green-200 bg-green-50/50 hover:shadow-lg transition-shadow">
              ...
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <CardDescription>Main workspace</CardDescription>
                  </div>
                </div>
              </div>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-muted-foreground mb-4">
                Create prospects, fill out audits, and generate public reports.
              </p>
              <Link to="/dashboard">
          ...
          <Card className="border-orange-200 bg-orange-50/50 hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground mb-4">
                Create, edit, and manage accounts for your team and VAs.
              </p>
          ...
          <Card className="border-purple-200 bg-purple-50/50 hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground mb-4">
                View a sample audit report to see what the final deliverable looks like for prospects. This shows the comprehensive analysis that will be customized for each business.
              </p>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  This system enables Yak Media to perform comprehensive 10-point marketing audits for businesses across 
                  all industries. The goal is to gather clear data, screenshots, and notes that demonstrate where we can 
                  create better marketing outcomes for potential clients.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Your job is to make sure the information is accurate, visual, and actionable. The data you collect 
                  will be used to build each prospect's personalized marketing audit report with specific, tailored recommendations.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="text-sm text-muted-foreground space-y-2 ml-4">
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 mt-0.5 text-green-600 flex-shrink-0" />
                    <span>Top 3 opportunities highlighted for each business</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 bg-slate-50 rounded-lg">
                <h4 className="mb-2">System Features</h4>
                <ul className="text-sm space-y-1">
                  <li className="text-muted-foreground">• Dashboard for prospect management</li>
                  <li className="text-muted-foreground">• Built-in audit form with all 10 categories</li>
                  <li className="text-muted-foreground">• Automated report generation at success.yak.media/companyname</li>
                  <li className="text-muted-foreground">• Screenshot upload and storage</li>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-amber-800">
                ...
                This is an ongoing prospecting tool designed to continuously build your pipeline.
              </p>
            </div>
          </div>
        </div>
