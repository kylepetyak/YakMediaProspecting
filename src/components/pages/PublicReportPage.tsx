...
export function PublicReportPage() {
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center p-4">
        <Card className="max-w-2xl">
          <CardContent className="pt-6">
            ...
            <div className="bg-slate-50 p-4 rounded-lg border mb-4 text-center">
              <h4 className="mb-2">💡 How to Create This Report</h4>
              <p className="text-sm text-muted-foreground mb-3">
                This report doesn't exist yet. Log into your dashboard to create a prospect with this company name.
              </p>
              <a href="/login">
  ...
  const auditPoints = auditFields.map((field, index) => {
    ...
    // Find corresponding screenshot from assets
    const screenshot = assets.find(asset => asset.kind === field.key)?.url || '';
  ...
  const reportData = {
    ...
    estimatedLeadsMin: audit.estimated_leads_min || 40,
    estimatedLeadsMax: audit.estimated_leads_max || 60,
    estimatedRevenueMin: audit.estimated_revenue_min || 25000,
    estimatedRevenueMax: audit.estimated_revenue_max || 40000
  };
