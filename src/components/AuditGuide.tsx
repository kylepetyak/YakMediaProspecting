      ...
      <div className="max-w-6xl mx-auto p-4 md:p-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Follow this step-by-step guide to conduct thorough marketing audits for potential clients across all industries. 
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="bg-white p-4 rounded-lg border border-green-200">
                ...
                <p className="text-sm text-muted-foreground">
                  Add scores, notes, and screenshots using the dashboard audit form
                </p>
              </div>
            </div>
          </CardContent>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                ...
                <ul className="text-sm text-amber-800 space-y-1">
                  ...
                  <li>• Businesses outside your target geographic area</li>
                  <li>• Large corporate chains (focus on independent businesses)</li>
                </ul>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="mb-8 border-green-200 bg-green-50/50">
          ...
          <CardContent>
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3 text-sm">
                <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                <span>Screenshots uploaded through the dashboard with clear labels</span>
              </div>
              <div className="flex items-start gap-3 text-sm">
                <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
              ...
              <div className="flex items-start gap-3 text-sm">
                <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                <span>All audit fields completed in the dashboard before publishing report</span>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mb-8 border-slate-200">
          <CardHeader>
            ...
            <CardDescription>
              How to document findings for creating personalized outreach
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div>
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-3 text-sm">
                  ...
                  and clearer offer/call-to-action above the fold."
                </div>
              </div>
